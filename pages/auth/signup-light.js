          ...
          <div className='card card-body' style={{maxWidth: '940px'}}>
            ...
            <div className='row mx-0 align-items-center'>
              <div className='col-md-6 border-end-md p-2 p-sm-5'>
                ...
                <div className='mt-sm-4 pt-md-3'>Already have an account? <Link href='/signin-light' legacyBehavior><a>Sign in</a></Link></div>
              </div>
                ...
                <Form noValidate validated={validated} onSubmit={handleSubmit}>
                  ...
                  <Form.Check
                    ...
                    label={[
                      ...
                      <Link key={2} href='#' legacyBehavior><a>Terms of use</a></Link>,
                      <span key={3}> and </span>,
                      <Link key={4} href='#' legacyBehavior><a>Privacy policy</a></Link>
                    ]}
                    required
                    className='mb-4'
                  />
