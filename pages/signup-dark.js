            ...
            <div className='row mx-0 align-items-center'>
              <div className='col-md-6 border-end-md border-light p-2 p-sm-5'>
                ...
                <div className='mt-sm-4 pt-md-3'>
                  ...
                  <Link href='/signin-dark' legacyBehavior><a className='text-light'>Sign in</a></Link>
                </div>
              </div>
                ...
                <Form noValidate validated={validated} onSubmit={handleSubmit}>
                  ...
                  <Form.Check
                    ...
                    label={[
                      ...
                      <Link key={2} href='#'><a className='text-light'>Terms of use</a></Link>,
                      <span key={3} className='opacity-70'> and </span>,
                      <Link key={4} href='#'><a className='text-light'>Privacy policy</a></Link>
                    ]}
                    required
