...
const NotFoundPage = () => {
  ...
  return (
    <>
      ...
      <Head>
        <title>ImmoAsk| Immobilier et foncier | 404 Not Found</title>
      </Head>
      ...
      <main className="page-wrapper">
        <section className="d-flex align-items-lg-center align-items-end position-relative min-vh-100 py-lg-5 py-0">
          <span
            className="position-absolute top-0 start-0 d-lg-block d-none w-100 h-100 zindex-1 bg-dark rounded-4 rounded-start-0"
            style={{ maxWidth: "43.6vw" }}
          ></span>
          <Container className="position-relative zindex-5">
            <Row className="gy-4 align-items-md-center">
              <Col
                ...
                className="position-relative py-lg-0 py-5 text-lg-start text-center"
              >
                ...
                <div className="position-relative zindex-5">
                  ...
                  <p
                    className="mx-auto mb-lg-4 mb-3 pb-lg-3 fs-lg text-light opacity-70"
                    style={{ maxWidth: "576px" }}
                  >
                    Sorry, we can&apos;t find the page you are looking for. We
                    suggest you go to homepage while we are fixing the problem.
                  </p>
                  <svg
                    className="d-lg-block d-none mb-4"
                  ...
                  <div className="d-flex flex-sm-row flex-column justify-content-lg-start justify-content-sm-center ms-n4">
                    <Link href="/tg" passHref legacyBehavior>
                      <Button size="lg" variant="primary mt-3 ms-4">
                        Go to homepage
                      </Button>
                    </Link>
                    <Link href="/tg/help-center" passHref legacyBehavior>
                      <Button size="lg" variant="outline-light mt-3 ms-4">
                        Visit help center
                      </Button>
                    </Link>
                  </div>
