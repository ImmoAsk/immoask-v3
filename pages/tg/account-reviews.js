...
const AccountReviewsPage = () => {
  ...
  return (
    <RealEstatePageLayout
      pageTitle='Avis des clients'
      activeNav='Account'
      userLoggedIn
    >
      <RealEstateAccountLayout accountPageTitle='Avis des clients'>
      <h1 className='h2'>Avis</h1>
        ...
        <Tab.Container defaultActiveKey='reviewsAboutYou' transition={Fade}>
          ...
          {/* Nav tabs */}
          <Nav variant='tabs' className='mb-4 flex-column flex-sm-row align-items-stretch align-items-sm-start border-bottom'>
            <Nav.Item className='mb-3 me-sm-3'>
          ...
          <Tab.Content>
            ...
            <Tab.Pane eventKey='reviewsAboutYou'>
              ...
              {/* Total + sorting */}
              <div className='pb-4 mb-2 d-flex flex-sm-row flex-column align-items-sm-center align-items-stretch justify-content-between mb-md-3'>
                <h3 className='h4 mb-sm-0'>
                  <i className='align-middle fi-star-filled mt-n1 me-2 lead text-warning'></i>
                  4,9 (32 reviews)
                </h3>
                <Form.Group controlId='sortby1' className='d-flex align-items-center ms-sm-4'>
                  <Form.Label className='mb-0 fs-sm text-body fw-normal text-nowrap me-2 pe-1'>
