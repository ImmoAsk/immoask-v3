...
const AboutPage = () => {
  ...
  const team = [
    {
      img: '/images/tg/about/team/01.jpg',
      name: 'Devon Lane',
    ...
    {
      img: '/images/tg/about/team/02.jpg',
      name: 'Dianne Russell',
    ...
    {
      img: '/images/tg/about/team/03.jpg',
    ...
    {
      img: '/images/tg/about/team/04.jpg',
      name: 'Albert Flores',
  ...
  const partners = [
    ['#', '/images/tg/brands/01_gray.svg', '/images/tg/brands/01_color.svg'],
    ['#', '/images/tg/brands/02_gray.svg', '/images/tg/brands/02_color.svg'],
    ['#', '/images/tg/brands/03_gray.svg', '/images/tg/brands/03_color.svg'],
    ['#', '/images/tg/brands/04_gray.svg', '/images/tg/brands/04_color.svg'],
    ['#', '/images/tg/brands/05_gray.svg', '/images/tg/brands/05_color.svg'],
    ['#', '/images/tg/brands/06_gray.svg', '/images/tg/brands/06_color.svg']
  ]
    ...
    >
      ...
      <Container as='section' className='mb-5 pb-2'>
        <Row className='gy-4 align-items-center justify-content-center'>
          ...
          <Col xs={{span: 12, order: 'last'}} sm={9} md={{span: 5, order: 'first'}} lg={4} className='text-md-start text-center'>
            ...
            <Link href='/tg/contacts' passHref legacyBehavior>
          ...
          <Col xs={{span: 12, order: 'first'}} md={{span: 6, order: 'first', offset: 1}} lg={7}>
            ...
            >
              <SwiperSlide className='d-flex'>
                <ImageLoader src='/images/tg/about/hero/01.jpg' width={792} height={510} alt='Image' className='rounded-3' />
              </SwiperSlide>
              <SwiperSlide className='d-flex'>
                <ImageLoader src='/images/tg/about/hero/02.jpg' width={792} height={510} alt='Image' className='rounded-3' />
              </SwiperSlide>
            </Swiper>
        ...
        <Row className='gy-4 pb-2 pb-sm-4'>
          <Col xs={12} md={5} className='text-md-start text-center'>
            <div className='d-inline-block'>
              <ImageLoader src='/images/tg/illustrations/find.svg' width={526} height={500} alt='Illustration' />
            </div>
          </Col>
          ...
          <Col xs={12} lg={10} className='position-relative px-3'>
            ...
            >
              <SwiperSlide className='h-auto'>
                <article className='d-flex flex-md-row flex-column h-100 p-3'>
                  <div className='d-md-flex d-none me-4 flex-shrink-0'>
                    <ImageLoader src='/images/tg/about/testimonials/01.jpg' width={306} height={260} alt='Image' className='rounded-3' />
                  </div>
              ...
              <SwiperSlide className='h-auto'>
                <article className='d-flex flex-md-row flex-column h-100 p-3'>
                  <div className='d-md-flex d-none me-4 flex-shrink-0'>
                    <ImageLoader src='/images/tg/about/testimonials/02.jpg' width={306} height={260} alt='Image' className='rounded-3' />
                  </div>
                  <Card className='border-0 shadow-sm h-100'>
                    <Card.Body
                      as={Blockquote}
        ...
        <div className='bg-secondary rounded-3'>
          <Col xs={12} md={{span: 11, offset: 1}} className='d-flex align-items-center justify-content-between p-md-0 p-2'>
            <div className='me-md-5 py-md-5 px-md-0 p-4' style={{maxWidth: '526px'}}>
              ...
              <Link href='/tg/catalog?type=sale' passHref legacyBehavior>
            ...
            <Col xs={4} className='d-md-block d-none align-self-end px-0'>
              <div className='d-flex flex-shrink-0 mt-n5'>
                <ImageLoader src='/images/tg/about/01.png' width={396} height={442} alt='Cover image' />
              </div>
            </Col>
          </Col>
        </div>
      ...
      <Container as='section' className='mb-5 pb-3 pb-lg-4'>
        <div className='d-sm-flex align-items-center justify-content-between mb-4 pb-2'>
          ...
          <Link href='/tg/blog' passHref legacyBehavior>
