        ...
        <Row className='g-0 mt-n3'>
            ...
            >
              ...
              {/* <Offcanvas.Header className='d-block border-bottom pt-0 pt-lg-4 px-lg-0'>
                <Nav variant='tabs' className='mb-0'>
                  <Nav.Item>
                    <Link href='/real-estate/catalog?category=rent' passHref legacyBehavior>
                  ...
                  <Nav.Item>
                    <Link href='/real-estate/catalog?category=sale' passHref legacyBehavior>
                ...
                <Nav.Item className='mt-1'>
                    <Link href='/real-estate/catalog?category=invest' passHref legacyBehavior>
                  ...
                  <Nav.Item className='mt-1'>
                    <Link href='/real-estate/catalog?category=bailler' passHref legacyBehavior>
          ...
          <Col lg={8} xl={9} className='position-relative overflow-hidden pb-5 pt-4 px-3 px-xl-4 px-xxl-5'>
            ...
            <Breadcrumb className='mb-3 pt-md-2'>
              <Link href='/tg/catalog' passHref legacyBehavior>
