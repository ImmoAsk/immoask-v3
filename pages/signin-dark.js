...
const SigninDarktPage = () => {
  ...
  return (
    <>
      ...
      <Head>
        <title>ImmoAsk | Sing In Page (Dark)</title>
      </Head>
            ...
            <div className='row mx-0 align-items-center'>
              <div className='col-md-6 border-end-md border-light p-2 p-sm-5'>
                ...
                <div className='text-light mt-4 mt-sm-5'>
                  ...
                  <Link href='/signup-dark' legacyBehavior><a className='text-light'>Sign up here</a></Link>
                </div>
              </div>
                  ...
                  <Form.Group className='mb-4'>
                    <div className='d-flex align-items-center justify-content-between mb-2'>
                      ...
                      <Link href='#' legacyBehavior>
                        <a className='fs-sm text-light'>Forgot password?</a>
                      </Link>
                    </div>
