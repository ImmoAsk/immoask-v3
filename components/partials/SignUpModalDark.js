          ...
          <div className='col-md-6 px-4 pt-2 pb-4 px-sm-5 pb-sm-5 pt-md-5'>
            ...
            <Form noValidate validated={validated} onSubmit={handleSubmit}>
              ...
              <Form.Check
                type='checkbox'
                id='terms-agree'
                label={[<span key={1} className='opacity-70'>By joining, I agree to the </span>, <Link key={2} href='#' legacyBehavior><a className='text-light'>Terms of use</a></Link>, <span key={3} className='opacity-70'> and </span>, <Link key={4} href='#' legacyBehavior><a className='text-light'>Privacy policy</a></Link>]}
                required
