      ...
      <Row className='justify-content-center pb-sm-2'>
        <Col lg={11} xl={10}>
          ...
          <div className='d-flex flex-column flex-sm-row bg-light rounded-3 p-4 px-md-5'>
            {prevStep && <Link href={prevStep} passHref legacyBehavior>
              <Button size='lg' variant='outline-primary rounded-pill'>
                <i className='fi-chevron-left fs-sm me-2 ms-n1'></i>
                Previous step
              </Button>
            </Link>}
            {nextStep && <Link href={nextStep} passHref legacyBehavior>
              <Button size='lg' variant='primary rounded-pill ms-auto' className='mt-sm-0 mt-3'>
                Next step
