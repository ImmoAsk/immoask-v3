            ...
            <aside className='fixed-nav-start bg-dark'>
              ...
              <SimpleBar className='fixed-nav-body simplebar-light pt-2 pb-4'>
                ...
                <Nav as='nav' className='nav-light flex-column' activeKey={props.activeNav}>
                  ...
                  <Link href='/components/icon-font' passHref legacyBehavior>
                    <Nav.Link className='fs-sm'>Icon font</Nav.Link>
                  </Link>
                  <Link href='/components/code' passHref legacyBehavior>
                    <Nav.Link className='fs-sm'>Code</Nav.Link>
                  </Link>
                  <Link href='/components/images' passHref legacyBehavior>
                    <Nav.Link className='fs-sm'>Images &amp; figures</Nav.Link>
                  </Link>
                  <Link href='/components/tables' passHref legacyBehavior>
                ...
                <Nav as='nav' className='nav-light flex-column' activeKey={props.activeNav}>
                  ...
                  <Link href='/components/alerts' passHref legacyBehavior>
                  ...
                  <Link href='/components/breadcrumb' passHref legacyBehavior>
                  ...
                  <Link href='/components/button-group' passHref legacyBehavior>
                    <Nav.Link className='fs-sm'>Button group</Nav.Link>
                  </Link>
                  <Link href='/components/cards-basic' passHref legacyBehavior>
                    <Nav.Link className='fs-sm'>Cards: Basic</Nav.Link>
                  </Link>
                  <Link href='/components/cards-advanced' passHref legacyBehavior>
                    <Nav.Link className='fs-sm'>Cards: Advanced</Nav.Link>
                  </Link>
                  <Link href='/components/carousel' passHref legacyBehavior>
                    <Nav.Link className='fs-sm'>Carousel (Slider)</Nav.Link>
                  </Link>
                  <Link href='/components/date-picker' passHref legacyBehavior>
                    <Nav.Link className='fs-sm'>Date / time picker</Nav.Link>
                  </Link>
                  <Link href='/components/dropdowns' passHref legacyBehavior>
                    <Nav.Link className='fs-sm'>Dropdowns</Nav.Link>
                  </Link>
                  <Link href='/components/file-uploader' passHref legacyBehavior>
                  ...
                  <Link href='/components/form-group' passHref legacyBehavior>
                    <Nav.Link className='fs-sm'>Form group</Nav.Link>
                  </Link>
                  <Link href='/components/gallery' passHref legacyBehavior>
                    <Nav.Link className='fs-sm'>Gallery</Nav.Link>
                  </Link>
                  <Link href='/components/input-group' passHref legacyBehavior>
                    <Nav.Link className='fs-sm'>Input group</Nav.Link>
                  </Link>
                  <Link href='/components/icon-box' passHref legacyBehavior>
                    <Nav.Link className='fs-sm'>Icon box</Nav.Link>
                  </Link>
                  <Link href='/components/maps' passHref legacyBehavior>
                    <Nav.Link className='fs-sm'>Interactive maps</Nav.Link>
                  </Link>
                  <Link href='/components/list-group' passHref legacyBehavior>
                    <Nav.Link className='fs-sm'>List group</Nav.Link>
                  </Link>
                  <Link href='/components/modal' passHref legacyBehavior>
                    <Nav.Link className='fs-sm'>Modal</Nav.Link>
                  </Link>
                  <Link href='/components/navbar' passHref legacyBehavior>
                    <Nav.Link className='fs-sm'>Navbar</Nav.Link>
                  </Link>
                  <Link href='/components/offcanvas' passHref legacyBehavior>
                    <Nav.Link className='fs-sm'>Offcanvas</Nav.Link>
                  </Link>
                  <Link href='/components/pagination' passHref legacyBehavior>
                    <Nav.Link className='fs-sm'>Pagination</Nav.Link>
                  </Link>
                  <Link href='/components/parallax' passHref legacyBehavior>
                    <Nav.Link className='fs-sm'>Parallax</Nav.Link>
                  </Link>
                  <Link href='/components/pills' passHref legacyBehavior>
                    <Nav.Link className='fs-sm'>Pills</Nav.Link>
                  </Link>
                  <Link href='/components/placeholders' passHref legacyBehavior>
                    <Nav.Link className='fs-sm'>Placeholders</Nav.Link>
                  </Link>
                  <Link href='/components/popovers' passHref legacyBehavior>
                    <Nav.Link className='fs-sm'>Popovers</Nav.Link>
                  </Link>
                  <Link href='/components/pricing' passHref legacyBehavior>
                    <Nav.Link className='fs-sm'>Pricing</Nav.Link>
                  </Link>
                  <Link href='/components/progress' passHref legacyBehavior>
                    <Nav.Link className='fs-sm'>Progress</Nav.Link>
                  </Link>
                  <Link href='/components/social-buttons' passHref legacyBehavior>
                    <Nav.Link className='fs-sm'>Social buttons</Nav.Link>
                  </Link>
                  <Link href='/components/spinners' passHref legacyBehavior>
                    <Nav.Link className='fs-sm'>Spinners</Nav.Link>
                  </Link>
                  <Link href='/components/steps' passHref legacyBehavior>
                  ...
                  <Link href='/components/testimonials' passHref legacyBehavior>
                    <Nav.Link className='fs-sm'>Testimonials / reviews</Nav.Link>
                  </Link>
                  <Link href='/components/toasts' passHref legacyBehavior>
                    <Nav.Link className='fs-sm'>Toasts</Nav.Link>
                  </Link>
                  <Link href='/components/tooltips' passHref legacyBehavior>
                ...
                <Nav as='nav' className='nav-light flex-column' activeKey={props.activeNav}>
                  ...
                  <Link href='/components/utilities' passHref legacyBehavior>
