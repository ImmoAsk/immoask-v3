...
const DeletePropertyModal = ({ property, onSwap, pillButtons, ...props }) => {
      ...
      <Modal.Body className='px-0 py-2 py-sm-0'>
        ...
        <div className='row mx-0'>
          <div className='col-md-6 border-end-md p-4 p-sm-5'>
            <h2 className='h3 mb-2 mb-sm-2'>Rendre indisponible le bien immobilier N° {property.nuo}</h2>
          ...
          <div className='col-md-6 p-4 p-sm-5'>
            <h3 className='h4'>
              Indisponibitlité du bien immobilier N° {property.nuo}. Bonne chance !
            </h3>
